...
import com.bezkoder.springjwt.repository.EntrepreneurRepository;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		User user = new User(signUpRequest.getUsername(),
				...
				signUpRequest.getFaculte(),
				signUpRequest.getPromotion(),
		...
		Role condidatRole = roleRepository.findByName(ERole.ROLE_CANDIDAT)
	...
	@PostMapping("/formC")
	public ResponseEntity<?> registerCondidat(@Valid @RequestBody SignupRequest signUpRequest) {
		if (userRepository.existsByUsername(signUpRequest.getUsername())) {
			return ResponseEntity
					.badRequest()
					.body(new MessageResponse("Error: Username is already taken!"));
